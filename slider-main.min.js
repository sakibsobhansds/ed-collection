...
class ProductSliderItemDevPs extends HTMLElement {
  constructor() {
    ...
    if (this.addedButton != null) {
      this.addedButton.addEventListener(
        "click",
        this.addToCartBtnClick.bind(this)
      );
    }
  ...
  featchData() {
    ...
    fetch(window.Shopify.routes.root + "cart/add.js", {
      ...
      .then((data) => {
        ...
        const cartNoticeElement = document.querySelector(
          ".added_to_cart#cart-cont-" + dataBlockId
        );
        if (data.status === 422) {
        ...
        this.countUpdate().forEach((section) => {
          ...
          if(elementToReplace){
            elementToReplace.innerHTML = new DOMParser().parseFromString(data.sections["cart-icon-bubble"], "text/html").querySelector("#shopify-section-cart-icon-bubble").innerHTML;
          }
...
document.addEventListener("DOMContentLoaded", function(event) {
  if(document.querySelector(".ss-ps-item-add-to-cart")){
    document.querySelector(".ss-ps-item-add-to-cart").addEventListener("easyDisplayEvent", (event) => {
...
document.querySelectorAll(".swiper").forEach((slider) => {
  if (slider.dataset.slideroptions != undefined) {
    ...
    // Seperate the swiper controller from the sliderSettings meta data settings
    ...
    // Insert the navigationBtn markup inside sliderSettingsdata
    let sliderSettingsdata = Object.assign({}, settingsdata, navigationBtn);
    // Initialize The slider
    new Swiper(`#${slider.id}`, sliderSettingsdata);
  }
});
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  grid_data.forEach((grid) => {
    ...
    if (
      gridSettings.enableMasonry != "undefined" &&
      gridSettings.enableMasonry == true
    ) {
      document
        .querySelector(`#${grid.id}` + " .swiper-wrapper")
        .classList.toggle("masonry");
      imagesLoaded(grid_data, function () {
        // init Isotope after all images have loaded
        new Masonry(
          document.querySelector(`#${grid.id}` + " .swiper-wrapper.masonry"),
          {
            itemSelector:
              `#${grid.id}` + " .swiper-wrapper.masonry .swiper-grid",
            // fitWidth: true,
            gutter: 10,
          }
        );
      ...
      const counter = setInterval(function () {
        ...
        if (getStartDate < now && getEndDate > now) {
          ...
          element.innerHTML =
            ...
            '</span><span class="desc">Days</span></li><li class="separator"></li><li class="hours"><span class="count">' +
            Math.floor((distance % day) / hour) +
            '</span><span class="desc">Hours</span></li><li class="separator"></li><li class="minutes"><span class="count">' +
            Math.floor((distance % hour) / minute) +
            '</span><span class="desc">Mins</span></li><li class="separator"></li><li class="seconds"><span class="count">' +
            Math.floor((distance % minute) / second) +
            '</span><span class="desc">Secs</span></li></ul>';
        } else {
